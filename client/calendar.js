...
class Calendar {
  ...
  render() {
    ...
    let filters = c('div');
    let dates = c('div');
    let currentdate = el.currentdate;
    ...
    function loadCalendarDays() {
      ...
      for (let i = 0; i < num; i++) {
        var tmp = i + 1;
        var d = document.createElement("div"); // d.id="calendarday_" + i; d.className="day" ; d.innerHTML=tmp; d.dataset.day=tmp;
        if (tmp == currentday) {
          let _date = (currentmonth + 1) + '/' + currentday + '/' + currentyear;
        ...
        d.addEventListener('click', function() {
          let _date = (currentmonth + 1) + '/' + this.dataset.day + '/' + currentyear;
          el.selectedDays = new Array();
    ...
    function loadCalendarYears() {
      ...
      div_label.innerHTML = currentyear;
      ...
      for (let i = startYear; i <= endYear; i++) {
        ...
        doc.onclick = (function() {
          ...
          return function() {
            year = selectedYear;
            div_label.innerHTML = `<span class='fa fa-caret-down fa-fw'></span>
    ${year}`;
            loadCalendarDays();
            $('.calendar-years').hide('fast');
            return year;
          }
        })();
    ...
    function loadCalendarMonths() {
      ...
      console.log('cur month: ' + currentmonth);
      ...
      div_dropdown.classList.add('calendar-months');
      div_dropdown.classList.add('months');
      div_dropdown.classList.add('dropdown');
      // div_dropdown.id = 'calendar';
...
//function loadCalendarMonths() {
// for (var i = 0; i < months.length; i++) { // var doc=document.createElement("div"); // doc.innerHTML=months[i]; // doc.classList.add("dropdown-item"); // doc.onclick=(function () { // var selectedMonth=i; // return function () { //
month = selectedMonth; // document.getElementById("curMonth").innerHTML=`<span class='fa fa-caret-down fa-fw'></span> ${months[month]}`;
// loadCalendarDays();
// return month;
// }
// })();
...
function loadCalendarDays() {
  ...
  for (var i = 0; i < num; i++) {
    ...
    d.className = "day";
    d.innerHTML = tmp;
    d.dataset.day = tmp; /* ****************** Single Day Event ********************** */
    d.addEventListener('click', function() {
      let _date = (month +
        1) + '/' + this.dataset.day + '/' + year;
